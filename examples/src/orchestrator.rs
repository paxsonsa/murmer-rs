        ...
        coordinator_ep
            .send(NotifyNodeJoined {
                ...
                info: SerializableNodeInfo {
                    ...
                    endpoint_id: store_a_cluster.identity().endpoint_id,
        ...
        coordinator_ep
            .send(NotifyNodeJoined {
                ...
                info: SerializableNodeInfo {
                    ...
                    endpoint_id: store_b_cluster.identity().endpoint_id,
                    class: NodeClass::Worker,
        ...
        coordinator_ep
            .send(NotifyNodeJoined {
                ...
                info: SerializableNodeInfo {
                    ...
                    endpoint_id: cluster.identity().endpoint_id,
        ...
        coordinator_ep
            .send(NotifyNodeJoined {
                ...
                info: SerializableNodeInfo {
                    ...
                    endpoint_id: b_cluster.identity().endpoint_id,
                    class: NodeClass::Worker,
